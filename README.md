...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 65d9536a-2994-407d-95d8-f69c4aa0a1bb
```

> `65d9536a-2994-407d-95d8-f69c4aa0a1bb` is the password of the certificate, you can change it to any password you want.
